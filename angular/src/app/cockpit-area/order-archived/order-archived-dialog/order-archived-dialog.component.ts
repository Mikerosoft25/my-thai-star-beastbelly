...
import { BookingView, OrderListView, OrderView } from 'app/shared/view-models/interfaces';

@Component({
  selector: 'app-order-archived-dialog',
  templateUrl: './order-archived-dialog.component.html',
  styleUrls: ['./order-archived-dialog.component.scss'],
})
export class OrderArchivedDialogComponent implements OnInit {
  private fromRow = 0;
