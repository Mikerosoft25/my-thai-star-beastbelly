...
const emailConfirmationsServiceSuccessStub =
  jasmine.createSpyObj<EmailConfirmationsService>('EmailConfirmationsService', {
...
const emailConfirmationsServiceErrorStub =
  jasmine.createSpyObj<EmailConfirmationsService>('EmailConfirmationsService', {
