= My Thai Star by Team beastbelly during the SEP 2021

This repository contains the extended and improved MyThaiStar application made by **team beastbelly** during the **SEP 2021** of the **Mannheim University of Applied Sciences** in cooperation with **Capgemini**.
The original project created by **Capgemini** can be found link:https://github.com/devonfw/my-thai-star[here].
All rights remain with **Capgemini**.
