...
This repository contains the extended and improved MyThaiStar application made by **team beastbelly** during the **SEP 2021** of the **Mannheim University of Applied Sciences**.
