...
/**
 * Unit Tests for {@link Bookingmanagement#declineInvite}
 *
 */
@SpringBootTest(classes = SpringBootApp.class)
@TestInstance(Lifecycle.PER_CLASS)
public class declineInviteTest extends ApplicationComponentTest {
  ...
  /**
   * Tests that a valid invite can be declined.
   */
  @Test
  public void declineInviteValid() {
    ...
    invitedGuest1 = this.bookingmanagement.declineInvite(guest1.getGuestToken());
    ...
    assertThat(invitedGuest1.getAccepted()).isFalse();
    assertThat(invitedGuestFromDB.getAccepted()).isFalse();

  }

  /**
   * Tests that an invite cannot be declined for a booking in the next hour.
   */
  @Test
  public void declineInviteInvalidBookingInNextHour() {
    ...
    assertThatThrownBy(() -> {
      this.bookingmanagement.declineInvite(guest1.getGuestToken());
    }).isInstanceOf(RuntimeException.class);

  }

  /**
   * Tests that an invite cannot be declined for a booking in the past.
   */
  @Test
  public void declineInviteInvalidBookingInPast() {
   ...
   */
  @Test
  public void declineInviteInvalidInviteHasAlreadyBeenAccepted() {
   ...
   */
  @Test
  public void declineInviteInvalidBookingToken() {

    assertThatThrownBy(() -> {
      this.bookingmanagement.declineInvite("invalidToken");
   ...
   */
  @Test
  public void declineInviteInvalidBookingTokenIsNull() {

    assertThatThrownBy(() -> {
      this.bookingmanagement.declineInvite(null);
    }).isInstanceOf(NullPointerException.class);
