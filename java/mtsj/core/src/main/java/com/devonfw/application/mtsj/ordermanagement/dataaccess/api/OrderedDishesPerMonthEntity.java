...
/**
 * {@link ApplicationPersistenceEntity Entity} that represents a single {@link OrderedDishesPerMonthEntity} of an
 * {@link OrderedDishes}.
 */
@Entity
@Immutable
...
public class OrderedDishesPerMonthEntity extends ApplicationPersistenceEntity implements OrderedDishes {
  ...
  /**
   * @param amount of ordered dished per day {@link #getAmount}.
   */
  @Override
